...
describe("Poultry calculations", () => {
  ...
  it("calculates a weighted sale with a dot or comma and respects a confirmed total", () => { expect(saleTotal(null, "2.6", "180", null)).toBe("468.00"); expect(saleTotal(null, "2,6", "180,5", null)).toBe("469.30"); expect(saleTotal(30, null, "8", "250")).toBe("250"); });
