...
# 2026-08-13 — Косметология

- Добавлен отдельный модуль: клиенты, процедуры, препараты, партии, расходы и аналитика.
- Визит создаёт один доход и списывает материалы по партиям; удаление визита возвращает остатки.
- Финансовый журнал, проекты, главная и отчёты показывают модуль «Косметология».

# 2026-08-14 — Записи косметологии

- Запись клиента стала отдельным планируемым действием: она не создаёт доход и не списывает материалы.
- При закрытии процедуры мастер подтверждает фактическую услугу, оплату и расходники; техкарта добавляет стандартные материалы.

# 2026-08-14 — Рабочий кабинет косметолога

- Добавлены предоплаты, раздельные кошельки наличных, Monobank, ПриватБанка и «На закупку».
- Закупки и операционные расходы уменьшают выбранный кошелёк; остаток ниже заданного минимума виден на главной.
- Добавлены минимальный остаток товара, поставщик закупки, долги клиентов, свободные теги и связь с рекомендателем.
