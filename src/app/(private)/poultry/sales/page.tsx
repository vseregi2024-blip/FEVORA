...
export default async function PoultrySalesPage({ searchParams }: { searchParams: Promise<{ batchId?: string; returnTo?: string; period?: string; all?: string }> }) {
