...
function category(type: string | null) {
  if (/зерн|пшениц|кукуруз/i.test(type ?? "")) return "grain";
  if (/добав|мук|дрож|фосфат|трикальц|бмвд/i.test(type ?? "")) return "additive";
  return "compound";
}
