...
export default async function SalePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <>
    ...
    <form action={updateSaleAction} className="transaction-form"><input type="hidden" name="id" value={sale.id}/>
      ...
      <div className="form-grid"><label>Количество<input name="quantity" required inputMode="numeric" defaultValue={sale.quantity}/></label><label>Цена за единицу<input name="unitSalePrice" required inputMode="decimal" defaultValue={sale.unitSalePrice.toString()}/></label></div>
