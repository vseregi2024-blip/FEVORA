...
export default async function PurchasesPage() {
  ...
  return <>
    ...
    <section className="family-grid"><article className="app-card"><h2>Новая закупка</h2><form action={createPurchaseAction} className="compact-form">
      ...
      <div className="form-grid"><label>Количество<input name="quantity" required inputMode="numeric" placeholder="10"/></label><label>Цена за единицу<input name="unitPurchasePrice" required inputMode="decimal" placeholder="500"/></label></div>
